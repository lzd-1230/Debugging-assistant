...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.save_data_btn = QtWidgets.QPushButton(self.uart_tab)
        self.save_data_btn.setMinimumSize(QtCore.QSize(7, 0))
        self.save_data_btn.setIconSize(QtCore.QSize(16, 16))
        self.save_data_btn.setAutoExclusive(False)
        self.save_data_btn.setDefault(False)
        self.save_data_btn.setFlat(False)
        self.save_data_btn.setObjectName("save_data_btn")
        self.gridLayout_6.addWidget(self.save_data_btn, 0, 0, 1, 1)
        self.clear_data_btn = QtWidgets.QPushButton(self.uart_tab)
        self.clear_data_btn.setObjectName("clear_data_btn")
        self.gridLayout_6.addWidget(self.clear_data_btn, 1, 0, 1, 1)
